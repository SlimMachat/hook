export const moviesData = [
    {
      id: Math.random(),
      image:
        'https://ih1.redbubble.net/image.879044021.2028/fposter,small,wall_texture,product,750x1000.jpg',
      rating: 5,
      name: "Fight Club",
      date: '1998',
      type: 'Action | philosophy',
      description:
        "Summaries. An insomniac office worker and a devil-may-care soapmaker form an underground fight club that evolves into something much, much more. A nameless first person narrator (Edward Norton) attends support groups in attempt to subdue his emotional state and relieve his insomniac state.",
    },
    {
      id: Math.random(),
      image:
